...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    super.initState();
    // myAnimationController1 = AnimationController(
    //   duration: const Duration(seconds: 2),
    //   // vsync: this,
    // );
    // myAnimation1 = CurvedAnimation(
    //   parent: myAnimationController1!,
    //   curve: Curves.bounceOut,
    // );
    // myAnimationController1!.forward();
    // myAnimationController1!.addListener(() {
    //   setState(() {
    //     emailController.text = 'mm';
    //   });
